...
```{r eval = FALSE}
report("thenameofyourmetadataspreadsheet.xlsx", "the/path/to/your/datafiles", report = "html")
```
...
```{r eval=FALSE}
my_medata_spreadsheet <- read_excel("thenameofyourmetadataspreadsheet.xlsx")
