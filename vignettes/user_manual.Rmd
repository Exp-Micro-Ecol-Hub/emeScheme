...
* A spreadsheet file `expt1_emeScheme.xlsx` (identical to this [googlesheet](https://docs.google.com/spreadsheets/d/1plu2RO9Ft5zruUX4on6oSukBlQAzKd8vskAL8b1s734))
...
If you're working through the worked example (`basic`), open the `expt1_emeScheme.xlsx` file, or open the [googlesheet](https://docs.google.com/spreadsheets/d/1plu2RO9Ft5zruUX4on6oSukBlQAzKd8vskAL8b1s734).
